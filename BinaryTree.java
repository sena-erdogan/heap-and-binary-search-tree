...
private int size(Node<E> root){
	...
	else if(root.left != null)	return 1 + size(root.left);
	else	return 1 + size(root.right);
...
Calls the private method to convert a subtree to a string
 @return the subtree as a string
*/
public String toString() {
